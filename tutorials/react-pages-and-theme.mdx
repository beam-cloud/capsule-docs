...
Capsule hot-reloads the React page along with the Python app. The SDK also generates `.capsule/types` so the local page environment has the right type stubs while you iterate.
