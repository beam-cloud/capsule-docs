...
Capsule apps often need three different kinds of external state:
...
- Use integrations inside background work with [Tasks And Schedules](/tutorials/tasks-and-schedules)
