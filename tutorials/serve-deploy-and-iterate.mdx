...
This tutorial connects the day-to-day CLI commands into one workflow.
...
The deploy output shows the version and hosted URL.

## 7. Smoke test the deployed app from Python

The SDK includes a simple programmatic client:
