...
Secrets are workspace-owned values. Use them for model API keys, OAuth client secrets, internal service tokens, and other credentials that belong to the app operator.
