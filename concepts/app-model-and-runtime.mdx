...
When people ask what a Capsule app actually is, the shortest answer is: it is one Python definition that Capsule can run for real users who sign into that app.
