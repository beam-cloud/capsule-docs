...
description: "Understand conversation state, user identity, and transport channels in Capsule."
---

`Session` is the runtime object that makes Capsule feel like an application framework instead of a raw webhook handler.
